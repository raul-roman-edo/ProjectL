...
import com.insurancetelematics.team.projectl.android.core.cards.SpacesItemDecoration;
...
public class CommentsFragment extends CardsFragment<CommentsPresenter> implements CommentsView {
    ...
    protected RecyclerView.ItemDecoration obtainItemDecoration() {
        return new SpacesItemDecoration(getResources().getDimensionPixelSize(R.dimen.card_margins));
    }
